@testset "Test some CIR functions" begin
    ...
    @test_nowarn FeynmanKacParticleFilters.generic_forward_filtering_backward_smoothing_algorithm_logweights(Mt, logGt, Nparts, Nparts, RS, transition_logdensity_CIR)
