...
function sample_from_filtering_distributions_dict(particle_filter_output, nsamples, index::Integer)
...
function sample_from_filtering_distributions_logweights_dict(particle_filter_output_logweights, nsamples, index::Integer)
